...
```bash
# 1. Download the .deb
wget https://github.com/owaistnt/VoxFree/raw/main/releases/voxfree_0.3.1_all.deb

# 2. Install
sudo dpkg -i voxfree_0.3.1_all.deb
...
```bash
sudo dpkg -i voxfree_0.3.1_all.deb   # dpkg handles the upgrade automatically
